...
7. Put PySpark.py and train/test dataset into HDFS and run command line:
   ...
   /bin/spark-submit /home/honeycomb/SparkTeam/PySpark.py /user/honeycomb/sparkteam/input/sample_multiclass_classification_data.txt /user/honeycomb/sparkteam/input/sample_multiclass_classification_data_test.txt /user/honeycomb/sparkteam/output
